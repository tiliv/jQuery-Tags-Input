...
c){c=jQuery.extend({focus:!1,callback:!0},c);this.each(function(){var e=a(this).attr("id"),d=a(this).val().split(j[e]);""==d[0]&&(d=[]);b=jQuery.trim(b);if(c.unique){var g=a(this).tagExist(b);!0==g&&a("#"+e+"_tag").addClass("not_valid")}else g=!1;if(""!=b&&!0!=g&&(a("<span>").addClass("tag").append(a("<span>").text(b),a("<a>",{href:"#",title:"Removing tag"}).html(a("#"+this.id+"_tagsinput").data("removeText")).click(function(){return a("#"+e).removeTag(escape(b))})).insertBefore("#"+e+"_addTag"),
d.push(b),a("#"+e+"_tag").val(""),c.focus?a("#"+e+"_tag").focus():a("#"+e+"_tag").blur(),a.fn.tagsInput.updateTagsField(this,d),c.callback&&(f[e]&&f[e].onAddTag)&&(g=f[e].onAddTag,g.call(this,b)),f[e]&&f[e].onChange)){var h=d.length,g=f[e].onChange;g.call(this,a(this),d[h-1])}});return!1};a.fn.removeTag=function(b){b=unescape(b);this.each(function(){var c=a(this).attr("id"),e=a(this).val().split(j[c]);a("#"+c+"_tagsinput .tag").remove();str="";for(i=0;i<e.length;i++)e[i]!=b&&(str=str+j[c]+e[i]);a.fn.tagsInput.importTags(this,
